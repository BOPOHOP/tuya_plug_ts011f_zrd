...
- 1.0.06
	- Изменен шаг записи энергии. Был 256, стал 16.
	- Добавлена корректная обработка команды [On with timed off](https://www.zigbee2mqtt.io/devices/TS011F_plug-SlD.html#on-with-timed-off). Доступна через `mqtt`.
